    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        check_output(
            [
                ...
                "-m",
                "snakemake",
                "results/reads/low_complexity/HD827sonic_2_lib3_collapsed.fastq.gz",
                "temp/reads/low_complexity/HD827sonic_2_lib3_collapsed.discarded.fastq.gz",
                "stats/reads/low_complexity/HD827sonic_2_lib3_collapsed.txt",
                "--snakefile",
                "../../workflow/Snakefile",
                "-f",
                "--notemp",
